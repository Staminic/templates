...
<a class="card-img-top" href="<?php echo $cck->getLink('md_mediation_readmore'); ?>">
  ...
  <div class="copyright"><?php echo $cck->renderField('md_mediation_vignette_caption'); ?></div>
</a>
...
<div class="card-body">
  ...
  <div class="card-text">
    <p class="meta">
      <a class="meta-link" href="<?php echo $cck->getLink('md_mediation_institution'); ?>"><?php echo $cck->getText('md_mediation_institution'); ?></a>
    </p>
    ...
    <p><?php echo $cck->renderField('md_mediationaccroche_2'); ?></p>
